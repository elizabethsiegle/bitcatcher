...
class ViewController: UIViewController
{
    ...
    //demo, will not work otherwise/elsewhere
    ...
    //server code update config to production values
//    Configuration.environment = var merchant_id: production Braintree.Configuration = YOUR_PRODUCTION_MERCHANT_ID
    
//    Configuration.public_key = YOUR_PRODUCTION_PUBLIC_KEY
//    
//    
//    Configuration.private_key = YOUR_PRODUCTION_PRIVATE_KEY
...
class MyViewController:BTDropInViewControllerDelegate {
    ...
    func dropInViewController(viewController: BTDropInViewController, didSucceedWithPaymentMethod: BTPaymentMethod) {
